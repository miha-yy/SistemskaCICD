...
def test_calculate_fibonacci():
    ...
    for n, expected_fibonacci_result in tests:
        ...
        assert fibonacci_result == expected_fibonacci_result, f"The {n}th Fibonacci number should be {expected_fibonacci_result}, got {fibonacci_result}"
...
def test_calculate_lucas():
    ...
    for n, expected_lucas_result in tests:
        ...
        assert lucas_result == expected_lucas_result, f"The {n}th Lucas number should be {expected_lucas_result}, got {lucas_result}"
